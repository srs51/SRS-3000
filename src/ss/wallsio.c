...
enum {
  /* must match entries in achToken (except TokenNot) */
  TokenNot=-1,
  TokenTime,
  TokenLengthUnit,
  TokenMassUnit,
...
#define NUM_TOKENS 31 /* must match number of entries in achToken (except TokenNot) */
...
enum {
  /* must match entries in achType (except TypeNot) */
  TypeNot=-1,
  TypePlane=WallPlane,
  TypeTriangle,
  TypeRectangle,
